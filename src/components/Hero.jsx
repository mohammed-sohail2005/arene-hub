...
const Hero = ({ onHostClick, onMultiClick }) => {
    return (
        <section className="hero" style={{ padding: '100px 20px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
            ...
            <p style={{ color: 'var(--text-dim)', maxWidth: '600px', margin: '0 auto 40px', fontSize: '1.1rem' }}>Host & compete in BGMI, Free Fire, and more. Join thousands of warriors battling for glory and massive prize pools.</p>
